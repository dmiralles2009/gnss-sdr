...
using beidou_b1c_telemetry_decoder_gs_sptr = boost::shared_ptr<beidou_b1c_telemetry_decoder_gs>;
 ...
 *
 */
class beidou_b1c_telemetry_decoder_gs : public gr::block
{
public:
    ~beidou_b1c_telemetry_decoder_gs();                   //!< Class destructor
...
private:
    ...
    beidou_b1c_telemetry_decoder_gs(const Gnss_Satellite &satellite, bool dump);
